...
const formatCount = count => {
    if (count) {
        ...
        if (int === 0) {
            ...
            // count 2.5 --> int = 2   fraction(0.5)-> 1/2  --> 2 1/2
    ...
    const markup = `
        ...
        <div class="recipe__ingredients">
            <ul class="recipe__ingredient-list">
                ${                      
                    // ! .map return an array but if use join after than return a string
                    recipe.ingredients.map(ingredientsElement => createIngredient(ingredientsElement)).join('')
                }
            </ul>
