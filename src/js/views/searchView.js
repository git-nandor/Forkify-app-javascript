import { elements, sanitize } from './base';

// Info: function 1 line without {} auto return the value
export const getInput = () => sanitize(elements.searchInput.value);
...
export const renderPaginatedResults = (results, page = 1, resPerPage = 10) => {
    ...
    // Info: give one callback to forEach will call it with every current element as param
